...
#%% cleaned text 
single_df_clean=single_df
multi_df_clean=multi_df
other_df_clean=other_df

def remove_special_characters(text):
    return re.sub(r'[^A-Za-zäöüÄÖÜß\s]', '', text)
single_df_clean['Content'] = single_df['Content'].apply(remove_special_characters)
single_df_clean['Question'] = single_df['Question'].apply(remove_special_characters)
single_df_clean['Correct Response'] = single_df['Correct Response'].apply(remove_special_characters)
single_df_clean['Response Option 1'] = single_df['Response Option 1'].apply(remove_special_characters)
single_df_clean['Response Option 2'] = single_df['Response Option 2'].apply(remove_special_characters)
single_df_clean['Response Option 3'] = single_df['Response Option 3'].apply(remove_special_characters)
single_df_clean['Response Option 4'] = single_df['Response Option 4'].apply(remove_special_characters)
single_df_clean['Response Option 5'] = single_df['Response Option 5'].apply(remove_special_characters)
single_df_clean['Response Option 6'] = single_df['Response Option 6'].apply(remove_special_characters)
single_df_clean['Response Option 7'] = single_df['Response Option 7'].apply(remove_special_characters)

other_df_clean['Content'] = other_df['Content'].apply(remove_special_characters)
other_df_clean['Question'] = other_df['Question'].apply(remove_special_characters)
other_df_clean['Correct Response'] = other_df['Correct Response'].apply(remove_special_characters)
other_df_clean['Response Option 1'] = other_df['Response Option 1'].apply(remove_special_characters)
other_df_clean['Response Option 2'] = other_df['Response Option 2'].apply(remove_special_characters)
other_df_clean['Response Option 3'] = other_df['Response Option 3'].apply(remove_special_characters)
other_df_clean['Response Option 4'] = other_df['Response Option 4'].apply(remove_special_characters)
other_df_clean['Response Option 5'] = other_df['Response Option 5'].apply(remove_special_characters)
other_df_clean['Response Option 6'] = other_df['Response Option 6'].apply(remove_special_characters)
other_df_clean['Response Option 7'] = other_df['Response Option 7'].apply(remove_special_characters)
...
#model = RobertaForCL.from_pretrained("ZurichNLP/unsup-simcse-xlm-roberta-base")
...
xlm-r-distilroberta-base-paraphrase-v1	    768
...
single_df_clean.reset_index(drop=True, inplace=True)
#embeddings
para_embd=[]
corr_embd=[]
quest_embd=[]
...
for i in range(len(single_df)):
    paragraph_embedding = model.encode(single_df_clean['Content'][i])
    response_correct_embedding = model.encode(single_df_clean['Correct Response'][i])
    question_embedding = model.encode(single_df_clean['Question'][i])
    response_1_embedding = model.encode(single_df_clean['Response Option 1'][i])
    response_2_embedding = model.encode(single_df_clean['Response Option 2'][i])
    response_3_embedding = model.encode(single_df_clean['Response Option 3'][i])
    response_4_embedding = model.encode(single_df_clean['Response Option 4'][i])
    response_5_embedding = model.encode(single_df_clean['Response Option 5'][i])
    response_6_embedding = model.encode(single_df_clean['Response Option 6'][i])
    response_7_embedding = model.encode(single_df_clean['Response Option 7'][i])
...
single_df_clean['Para Embedding'] = para_embd
single_df_clean['Correct Response Embedding'] = corr_embd
single_df_clean['Question Embedding'] = quest_embd
single_df_clean['Response Option 1 Embedding'] = response_1_embd
single_df_clean['Response Option 2 Embedding'] = response_2_embd
single_df_clean['Response Option 3 Embedding'] = response_3_embd
single_df_clean['Response Option 4 Embedding'] = response_4_embd
single_df_clean['Response Option 5 Embedding'] = response_5_embd
single_df_clean['Response Option 6 Embedding'] = response_6_embd
single_df_clean['Response Option 7 Embedding'] = response_7_embd

single_df_clean['Para-Question Similarity'] = para_question
single_df_clean['Question-Correct Response Similarity'] = question_response_correct
single_df_clean['Para-Correct Response Similarity'] = para_response_correct

single_df_clean['Para-Response Option 1 Similarity'] = para_response_1
single_df_clean['Para-Response Option 2 Similarity'] = para_response_2
single_df_clean['Para-Response Option 3 Similarity'] = para_response_3
single_df_clean['Para-Response Option 4 Similarity'] = para_response_4
single_df_clean['Para-Response Option 5 Similarity'] = para_response_5
single_df_clean['Para-Response Option 6 Similarity'] = para_response_6
single_df_clean['Para-Response Option 7 Similarity'] = para_response_7

single_df_clean['Question-Response Option 1 Similarity'] = quest_response_1
single_df_clean['Question-Response Option 2 Similarity'] = quest_response_2
single_df_clean['Question-Response Option 3 Similarity'] = quest_response_3
single_df_clean['Question-Response Option 4 Similarity'] = quest_response_4
single_df_clean['Question-Response Option 5 Similarity'] = quest_response_5
single_df_clean['Question-Response Option 6 Similarity'] = quest_response_6
single_df_clean['Question-Response Option 7 Similarity'] = quest_response_7
model_name_safe = model_name.replace('/', '_')
single_df_clean.to_csv(f'{model_name_safe}_single_df_clean.csv', index=False)
...
multi_df_clean['Content'] = multi_df['Content'].apply(remove_special_characters)
multi_df_clean['Question'] = multi_df['Question'].apply(remove_special_characters)
multi_df_clean['Correct Response'] = multi_df['Correct Response'].apply(remove_special_characters)
multi_df_clean['correct response 1'] = multi_df['correct response 1'].apply(remove_special_characters)
multi_df_clean['correct response 2'] = multi_df['correct response 2'].apply(remove_special_characters)
multi_df_clean['correct response 3'] = multi_df['correct response 3'].apply(remove_special_characters)
multi_df_clean['Response Option 1'] = multi_df['Response Option 1'].apply(remove_special_characters)
multi_df_clean['Response Option 2'] = multi_df['Response Option 2'].apply(remove_special_characters)
multi_df_clean['Response Option 3'] = multi_df['Response Option 3'].apply(remove_special_characters)
multi_df_clean['Response Option 4'] = multi_df['Response Option 4'].apply(remove_special_characters)
multi_df_clean['Response Option 5'] = multi_df['Response Option 5'].apply(remove_special_characters)
multi_df_clean['Response Option 6'] = multi_df['Response Option 6'].apply(remove_special_characters)
multi_df_clean['Response Option 7'] = multi_df['Response Option 7'].apply(remove_special_characters)
multi_df_clean.reset_index(drop=True,inplace=True)
#%%
# model names
# sentence-transformers/paraphrase-multilingual-MiniLM-L12-v2 ~ done for single & multi
...
for i in range(len(multi_df_clean)):
    paragraph_embedding = model.encode(multi_df_clean['Content'][i])
    response_correct_embedding = model.encode(multi_df_clean['Correct Response'][i])
    response_correct_embedding_1 = model.encode(multi_df_clean['correct response 1'][i])
    response_correct_embedding_2 = model.encode(multi_df_clean['correct response 2'][i])
    response_correct_embedding_3 = model.encode(multi_df_clean['correct response 3'][i])
    question_embedding = model.encode(multi_df_clean['Question'][i])
    response_1_embedding = model.encode(multi_df_clean['Response Option 1'][i])
    response_2_embedding = model.encode(multi_df_clean['Response Option 2'][i])
    response_3_embedding = model.encode(multi_df_clean['Response Option 3'][i])
    response_4_embedding = model.encode(multi_df_clean['Response Option 4'][i])
    response_5_embedding = model.encode(multi_df_clean['Response Option 5'][i])
    response_6_embedding = model.encode(multi_df_clean['Response Option 6'][i])
    response_7_embedding = model.encode(multi_df_clean['Response Option 7'][i])
...
multi_df_clean['Para Embedding'] = para_embd
multi_df_clean['Correct Response Embedding'] = corr_embd
multi_df_clean['Correct Response 1 Embedding'] =corr_embd_1
multi_df_clean['Correct Response 2 Embedding'] =corr_embd_2
multi_df_clean['Correct Response 3 Embedding'] =corr_embd_3
multi_df_clean['Question Embedding'] = quest_embd
multi_df_clean['Response Option 1 Embedding'] = response_1_embd
multi_df_clean['Response Option 2 Embedding'] = response_2_embd
multi_df_clean['Response Option 3 Embedding'] = response_3_embd
multi_df_clean['Response Option 4 Embedding'] = response_4_embd
multi_df_clean['Response Option 5 Embedding'] = response_5_embd
multi_df_clean['Response Option 6 Embedding'] = response_6_embd
multi_df_clean['Response Option 7 Embedding'] = response_7_embd
multi_df_clean['Para-Question Similarity'] = para_question
multi_df_clean['Question-Correct Response Similarity'] = question_response_correct
multi_df_clean['Question-Correct Response 1 Similarity'] =question_response_correct_1
multi_df_clean['Question-Correct Response 2 Similarity'] =question_response_correct_2
multi_df_clean['Question-Correct Response 3 Similarity'] =question_response_correct_3
multi_df_clean['Para-Correct Response Similarity'] = para_response_correct
multi_df_clean['Para-Correct Response 1 Similarity'] =para_response_correct_1
multi_df_clean['Para-Correct Response 2 Similarity'] =para_response_correct_2
multi_df_clean['Para-Correct Response 3 Similarity'] =para_response_correct_3
multi_df_clean['Para-Response Option 1 Similarity'] = para_response_1
multi_df_clean['Para-Response Option 2 Similarity'] = para_response_2
multi_df_clean['Para-Response Option 3 Similarity'] = para_response_3
multi_df_clean['Para-Response Option 4 Similarity'] = para_response_4
multi_df_clean['Para-Response Option 5 Similarity'] = para_response_5
multi_df_clean['Para-Response Option 6 Similarity'] = para_response_6
multi_df_clean['Para-Response Option 7 Similarity'] = para_response_7
multi_df_clean['Question-Response Option 1 Similarity'] = quest_response_1
multi_df_clean['Question-Response Option 2 Similarity'] = quest_response_2
multi_df_clean['Question-Response Option 3 Similarity'] = quest_response_3
multi_df_clean['Question-Response Option 4 Similarity'] = quest_response_4
multi_df_clean['Question-Response Option 5 Similarity'] = quest_response_5
multi_df_clean['Question-Response Option 6 Similarity'] = quest_response_6
multi_df_clean['Question-Response Option 7 Similarity'] = quest_response_7
model_name_safe = model_name.replace('/', '_')
multi_df_clean.to_csv(f'{model_name_safe}_multi_df_clean.csv', index=False)
